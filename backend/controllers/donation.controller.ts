...
// Extend Express Request type inline to include user
// export const createDonation = async (req: Request & { user?: { id: string } }, res: Response): Promise<void> => {
//   try {
...
//       donor: req.user.id, // Assign logged-in user as the donor
//       type,
//       amount,
//       status: "pending",
//     });
...
//      broadcastUpdate("donationUpdate", newDonation);  // Notify clients
